...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const allowedRoles = config.command_permissions.lock;
        ...
        try {
            ...
            const embedTemplate = config.embed_templates.lock;
            ...
            console.error(error);
            interaction.reply({ content: 'There was an error trying to lock the channel.', ephemeral: true });
        }
    }
};
